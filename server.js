...
app.use(express.static(path.join(__dirname, 'trackadmin')));
app.get("/addnewcompany",function(req,res){
    res.sendFile(__dirname + '/addnewcompany.html');

});//trackadmin//addCompanyModal
app.get("/trackadmin/client/views/addCompanyModal",function(req,res){
    res.sendFile(__dirname + '/trackadmin/client/views/addCompanyModal.html');

});
app.get("/trackadmin/client/index",function(req,res){
    res.sendFile(__dirname + '/trackadmin/client/index.html');

});
app.get("/trackadmin/index",function(req,res){
    res.sendFile(__dirname + '/trackadmin/index.html');
...
app.get("/testtable",function(req,res){
    res.sendFile(__dirname + '/testtable.ejs');
});
...
app.get('/table', authenticateController.table);
